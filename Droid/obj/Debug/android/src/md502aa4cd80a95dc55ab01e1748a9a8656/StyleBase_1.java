...
public abstract class StyleBase_1
	extends com.scichart.charting.visuals.renderableSeries.StyleBase
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SciChart.Charting.Visuals.RenderableSeries.StyleBase`1, SciChart.Android.Charting", StyleBase_1.class, __md_methods);
	}


	public StyleBase_1 (java.lang.Class p0)
	{
		super (p0);
		if (getClass () == StyleBase_1.class)
			mono.android.TypeManager.Activate ("SciChart.Charting.Visuals.RenderableSeries.StyleBase`1, SciChart.Android.Charting", "Java.Lang.Class, Mono.Android", this, new java.lang.Object[] { p0 });
	}
